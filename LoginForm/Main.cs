...
namespace LoginForm
{
    public partial class Main : Form
    {
        ...
        {
            NavPanel.Height = AnalyticsButton.Height;
            NavPanel.Top = AnalyticsButton.Top;
            NavPanel.Left = AnalyticsButton.Left;
            AnalyticsButton.BackColor = Color.FromArgb(46, 51, 73);

            label3.Text = AnalyticsButton.Text;
            this.FormLoaderPanel.Controls.Clear();
            Analytics analytics = new Analytics() { Dock = DockStyle.None, TopLevel=false, TopMost=true };
            analytics.FormBorderStyle = FormBorderStyle.None;
            this.FormLoaderPanel.Controls.Add(analytics); 
            analytics.Show();
        }
        ...
        private void AnalyticsButton_Leave(object sender, EventArgs e)
        {
            AnalyticsButton.BackColor = Color.FromArgb(24, 30, 54);
        }
